...
curl -o i-4.txt https://raw.githubusercontent.com/o0HalfLife0o/list/master/ad-edentw.txt
...
echo "! Description: 该规则合并自jiekouAD，AdGuard中文语言规则，乘风视频广告过滤规则、EasylistChina、EasylistLite、CJX'sAnnoyance，以及补充的一些规则，Adblock Warning Removal List、ABP filters、anti-adblock-killer-filters。" >> i-tpdate.txt
